			...
			<div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form method="POST" action="{{ route('login') }}" class="login100-form validate-form p-b-33 p-t-5">
					...
					<div class="wrap-input100">
						<input class="input100 @error('username') is-invalid @enderror" type="text" name="username" placeholder="Username or Email" autocomplete="off">
